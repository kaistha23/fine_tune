...
class Settings(BaseSettings):
    ...
    schema_registry_version: str = "1.3.0"
    ...
    # retention and access rules as the feedback log.
    interactions_path: Path = Path("data/feedback/interactions.jsonl")
    # Recorded on every interaction so a correction can be traced to what produced it.
    # "base" means no adapter is loaded.
